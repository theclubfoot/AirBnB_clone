...
class TestBaseModel(unittest.Testcase):
    ...
    def resertStorage(self):
        """ Resets FileStorage Date """
    ...
    def test_3_attribues(self):
        """ Test the attributes value for instance of the BaseModel class. """
    ...
    def test_3_datetime_created(self):
        """ Tests if updated_at and created_at works properly """
    ...
    def test_3_str(self):
        ...
        d2["created_at"] = repr(d2["updated_at"])
    ...
    def test_3_to_dict(self):
        ...
        self.assertEqual(d["created_at"], b.create_at.isoformat())
        self.assertEqual(d["updated_at"], b.create_at.isoformat())
